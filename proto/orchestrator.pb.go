...
=======
	LastUpdatedMs int64                  `protobuf:"varint,1,opt,name=last_updated_ms,json=lastUpdatedMs,proto3" json:"last_updated_ms,omitempty"` // timestamp of sender's memory
	MemoryJson    string                 `protobuf:"bytes,2,opt,name=memory_json,json=memoryJson,proto3" json:"memory_json,omitempty"`             // full JSON if pushing, empty if pulling
>>>>>>> 503e1dd31dbd36139d1fe6ea28cd20576bd44620
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
=======
	"\x0fcontent_preview\x18\x06 \x01(\tR\x0econtentPreview\"Y\n" +
	"\x0eChatMemorySync\x12&\n" +
	"\x0flast_updated_ms\x18\x01 \x01(\x03R\rlastUpdatedMs\x12\x1f\n" +
