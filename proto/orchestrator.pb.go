...
// Screenshot-based streaming (for Android)
type StreamScreenshotsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TargetFps     int32                  `protobuf:"varint,1,opt,name=target_fps,json=targetFps,proto3" json:"target_fps,omitempty"`       // default 8 if 0
	JpegQuality   int32                  `protobuf:"varint,2,opt,name=jpeg_quality,json=jpegQuality,proto3" json:"jpeg_quality,omitempty"` // default 60 if 0
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *StreamScreenshotsRequest) Reset() {
	*x = StreamScreenshotsRequest{}
	mi := &file_orchestrator_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StreamScreenshotsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamScreenshotsRequest) ProtoMessage() {}

func (x *StreamScreenshotsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_orchestrator_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamScreenshotsRequest.ProtoReflect.Descriptor instead.
func (*StreamScreenshotsRequest) Descriptor() ([]byte, []int) {
	return file_orchestrator_proto_rawDescGZIP(), []int{32}
}

func (x *StreamScreenshotsRequest) GetTargetFps() int32 {
	if x != nil {
		return x.TargetFps
	}
	return 0
...
func (x *StreamScreenshotsRequest) GetJpegQuality() int32 {
	if x != nil {
		return x.JpegQuality
	}
	return 0
...
func (x *ScreenshotFrame) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ScreenshotFrame) ProtoMessage() {}

func (x *ScreenshotFrame) ProtoReflect() protoreflect.Message {
	mi := &file_orchestrator_proto_msgTypes[33]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ScreenshotFrame.ProtoReflect.Descriptor instead.
func (*ScreenshotFrame) Descriptor() ([]byte, []int) {
	return file_orchestrator_proto_rawDescGZIP(), []int{33}
}

func (x *ScreenshotFrame) GetJpegData() []byte {
	if x != nil {
		return x.JpegData
	}
	return nil
...
const file_orchestrator_proto_rawDesc = "" +
	...
	"\x18StreamScreenshotsRequest\x12\x1d\n" +
	"\n" +
	"target_fps\x18\x01 \x01(\x05R\ttargetFps\x12!\n" +
	"\fjpeg_quality\x18\x02 \x01(\x05R\vjpegQuality\".\n" +
	"\x0fScreenshotFrame\x12\x1b\n" +
	"\tjpeg_data\x18\x01 \x01(\fR\bjpegData\"h\n" +
	...
	"\x0fREAD_MODE_RANGE\x10\x032\xbf\n" +
	"\n" +
	...
	"\n" +
	"StopWebRTC\x12\x14.edgemesh.WebRTCStop\x1a\x0f.edgemesh.Empty\x12T\n" +
	"\x11StreamScreenshots\x12\".edgemesh.StreamScreenshotsRequest\x1a\x19.edgemesh.ScreenshotFrame0\x01\x12Y\n" +
...
var file_orchestrator_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_orchestrator_proto_goTypes = []any{
	...
	(*StreamScreenshotsRequest)(nil), // 34: edgemesh.StreamScreenshotsRequest
	(*ScreenshotFrame)(nil),          // 35: edgemesh.ScreenshotFrame
	(*PlanPreviewRequest)(nil),       // 36: edgemesh.PlanPreviewRequest
	(*PlanPreviewResponse)(nil),      // 37: edgemesh.PlanPreviewResponse
	(*PlanCostRequest)(nil),          // 38: edgemesh.PlanCostRequest
	(*PlanCostResponse)(nil),         // 39: edgemesh.PlanCostResponse
	(*DeviceCostEstimate)(nil),       // 40: edgemesh.DeviceCostEstimate
	(*StepCostEstimate)(nil),         // 41: edgemesh.StepCostEstimate
	(*DownloadTicketRequest)(nil),    // 42: edgemesh.DownloadTicketRequest
	(*DownloadTicketResponse)(nil),   // 43: edgemesh.DownloadTicketResponse
	(*ReadFileRequest)(nil),          // 44: edgemesh.ReadFileRequest
	(*ReadFileResponse)(nil),         // 45: edgemesh.ReadFileResponse
}
var file_orchestrator_proto_depIdxs = []int32{
	...
	40, // 12: edgemesh.PlanCostResponse.device_costs:type_name -> edgemesh.DeviceCostEstimate
	41, // 13: edgemesh.DeviceCostEstimate.step_costs:type_name -> edgemesh.StepCostEstimate
	...
	36, // 27: edgemesh.OrchestratorService.PreviewPlan:input_type -> edgemesh.PlanPreviewRequest
	38, // 28: edgemesh.OrchestratorService.PreviewPlanCost:input_type -> edgemesh.PlanCostRequest
	...
	34, // 32: edgemesh.OrchestratorService.StreamScreenshots:input_type -> edgemesh.StreamScreenshotsRequest
	42, // 33: edgemesh.OrchestratorService.CreateDownloadTicket:input_type -> edgemesh.DownloadTicketRequest
	44, // 34: edgemesh.OrchestratorService.ReadFile:input_type -> edgemesh.ReadFileRequest
	4,  // 35: edgemesh.OrchestratorService.CreateSession:output_type -> edgemesh.SessionInfo
	2,  // 36: edgemesh.OrchestratorService.Heartbeat:output_type -> edgemesh.Empty
	6,  // 37: edgemesh.OrchestratorService.ExecuteCommand:output_type -> edgemesh.CommandResponse
	9,  // 38: edgemesh.OrchestratorService.RegisterDevice:output_type -> edgemesh.DeviceAck
	12, // 39: edgemesh.OrchestratorService.ListDevices:output_type -> edgemesh.ListDevicesResponse
	10, // 40: edgemesh.OrchestratorService.GetDeviceStatus:output_type -> edgemesh.DeviceStatus
	14, // 41: edgemesh.OrchestratorService.RunAITask:output_type -> edgemesh.AITaskResponse
	15, // 42: edgemesh.OrchestratorService.HealthCheck:output_type -> edgemesh.HealthStatus
	18, // 43: edgemesh.OrchestratorService.ExecuteRoutedCommand:output_type -> edgemesh.RoutedCommandResponse
	25, // 44: edgemesh.OrchestratorService.SubmitJob:output_type -> edgemesh.JobInfo
	26, // 45: edgemesh.OrchestratorService.GetJob:output_type -> edgemesh.JobStatus
	29, // 46: edgemesh.OrchestratorService.RunTask:output_type -> edgemesh.TaskResult
	37, // 47: edgemesh.OrchestratorService.PreviewPlan:output_type -> edgemesh.PlanPreviewResponse
	39, // 48: edgemesh.OrchestratorService.PreviewPlanCost:output_type -> edgemesh.PlanCostResponse
	31, // 49: edgemesh.OrchestratorService.StartWebRTC:output_type -> edgemesh.WebRTCOffer
	2,  // 50: edgemesh.OrchestratorService.CompleteWebRTC:output_type -> edgemesh.Empty
	2,  // 51: edgemesh.OrchestratorService.StopWebRTC:output_type -> edgemesh.Empty
	35, // 52: edgemesh.OrchestratorService.StreamScreenshots:output_type -> edgemesh.ScreenshotFrame
	43, // 53: edgemesh.OrchestratorService.CreateDownloadTicket:output_type -> edgemesh.DownloadTicketResponse
	45, // 54: edgemesh.OrchestratorService.ReadFile:output_type -> edgemesh.ReadFileResponse
